...
<body>
	...
	<div id="container">
		...
		<div class="textNadTab">
			...
			<?php
				...
				else
				{
					...
					sprintf("SELECT * FROM doctors where clinic_id=%s",
					mysqli_real_escape_string($polaczenie,$clinic))))
					{
		...
		<div id="footer" style="margin-top:250px;"> Najlepsza strona do umawiania wizyt Online!</div>
	</div>
